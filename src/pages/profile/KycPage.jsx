...
const KycPage = () => {
  ...
  const startVerification = (level) => {
    navigate("/profile/kyc/verify", { state: { level } });
  };
          ...
          {status ? (
            <div className="bg-[var(--background-secondary)] border border-[var(--border-color)] p-4 rounded-lg">
              ...
              {(status === "APPROVED" || status === "VERIFIED") && (
                <div>
                  <p className="text-sm text-[var(--text-secondary)] mb-4">
                    Your identity has been verified. You can now generate a
                    zero-knowledge proof to share your verification status
              ...
              {(status === "REJECTED" || status === "FAILED") && (
                <div>
                  <p className="text-sm text-[var(--text-secondary)] mb-4">
                    Your verification was not successful. Please try again with
                    valid documentation.
                  </p>
                  <button
            ...
            <p className="text-[var(--text-secondary)] mb-6">
              You have not completed KYC verification yet. Choose a verification
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="dark-card glass-effect border border-[var(--border-color)] rounded-lg p-4 hover:border-[var(--accent-primary)] transition-all">
                ...
                <p className="text-sm text-[var(--text-secondary)] mb-4">
                  Simple ID verification for basic access.
                </p>
                <button
              ...
              <div className="dark-card glass-effect border border-[var(--border-color)] rounded-lg p-4 hover:border-[var(--accent-primary)] transition-all">
                ...
                <p className="text-sm text-[var(--text-secondary)] mb-4">
                  Comprehensive ID verification for full access.
                </p>
                <button
              ...
              <div className="dark-card glass-effect border border-[var(--border-color)] rounded-lg p-4 hover:border-[var(--accent-primary)] transition-all">
                ...
                <p className="text-sm text-[var(--text-secondary)] mb-4">
                  Business entity verification for institutional access.
                </p>
                <button
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-separate border-spacing-0">
                  ...
                  <tbody className="text-[var(--text-primary)]">
                    {verificationsData.verifications.map(
                      (verification, index) => (
                        <tr
                          key={verification.id}
                          className={
                            index === verificationsData.verifications.length - 1
                              ? ""
