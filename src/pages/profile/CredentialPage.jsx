      ...
      <div className="text-sm text-[var(--text-secondary)] mb-3">
        <p>
          ...
          <span className="font-mono">
            {credential.issuer_did.substring(0, 16)}...
          </span>
        </p>
...
const CredentialsPage = () => {
  ...
  const credentialTypes = [
    "All",
    ...new Set(
      credentials.map((cred) => cred.credential_type || "Verifiable Credential")
    ),
  ];
  ...
  const filteredCredentials = credentials.filter((cred) => {
    const typeMatch =
      selectedType === "All" || cred.credential_type === selectedType;
      ...
      <div className="container mx-auto p-4">
        <div className="dark-card glass-effect p-6">
          ...
          <p className="text-center text-[var(--text-secondary)] mb-6">
            You need to create a decentralized identity (DID) to manage
            credentials.
          </p>
